...
When running the terms of the logistic model, none of them showed statistical significance which would point to the reason why the model wasn't able to accurately predict from training data.
# Gradient Boosting
```{r}
#build the model
library(gbm)
